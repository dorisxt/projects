 ...
 */
package com.huanxiao.yemao.template;
...
import com.huanxiao.yemao.template.Order.Direction;
...
public class Pageable implements Serializable {
	...
	public int hashCode() {
		return new HashCodeBuilder(17, 37).append(getPageNumber()).append(getPageSize()).append(getSearchProperty())
				.append(getSearchValue()).append(getOrderProperty()).append(getOrderDirection()).append(getFilters()).append(getOrders())
				.toHashCode();
	}
