/*
 * Copyright 2005-2013 huanxiao.com. All rights reserved.
 * Support: http://www.huanxiao.com
 * License: http://www.huanxiao.com/license
 * 
 * JavaScript - Common
 * Version 1.0_beta
 */
	...
	$.fn.extend({
		browser: function(options) {
			var settings = {
				...
				isUpload: true,
				browserUrl: yemao.base + "/admin/file/browser.jhtml",
				uploadUrl: yemao.base + "/admin/file/upload.jhtml",
				callback: null
			};
			$.extend(settings, options);
					...
					function createBrowserList(path, data) {
						...
						$.each(data, function(i, fileInfo) {
							...
							if (fileInfo.isDirectory) {
								iconUrl = yemao.base + "/resources/admin/images/folder_icon.gif";
								title = fileInfo.name;
								...
								iconUrl = yemao.base + "/resources/admin/images/file_icon.gif";
								title = fileInfo.name + " (" + Math.ceil(fileInfo.size / 1024) + "KB, " + new Date(fileInfo.lastModified).toLocaleString() + ")";
							}
